...
Partial Class VehicleLogReport2
    ...
    Protected Overrides Sub OnInit(ByVal e As System.EventArgs)
        Try
            ...
            dt = SecurityHelper.ExecuteSecureQuery(query, param)
        ...
        Catch ex As Exception
            SecurityHelper.LogError("VehicleLogReport OnInit Error", ex, Server)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            End If
        Catch ex As Exception
            SecurityHelper.LogError("VehicleLogReport Page_Load Error", ex, Server)
            Response.Redirect("Error.aspx")
        End Try
    End Sub
            ...
            If dt.Rows.Count > 0 Then
                For Each dr In dt.Rows
                    ...
                    If ((presentdatetime - previousdatetime).TotalMinutes >= interval) Then
                        ...
                        r(7) = "--"
                        If dr("pto") Then
                            r(7) = SecurityHelper.HtmlEncode(dr("alarm").ToString())
                        End If

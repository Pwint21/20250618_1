    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Else
                ...
                mvals = Request.QueryString("plateno") & "," & Request.QueryString("uid") & "," & Request.QueryString("tr") & "," & Request.QueryString("sr") & "," & Request.QueryString("dn") & "," & Request.QueryString("wo") & "," & Request.QueryString("sc") & "," & Request.QueryString("sn") & "," & Request.QueryString("ata")
                ...
                Dim userid As String = Request.Cookies("userinfo")("userid")
                juname = Request.Cookies("userinfo")("username").ToString().ToUpper()
                If userid = "7030" Or userid = "7031" Or userid = "7032" Or userid = "7033" Or userid = "1933" Or userid = "6779" Or userid = "6835" Or userid = "1618" Or userid = "1911" Or userid = "6826" Then
                    ucheck = "True"
                End If

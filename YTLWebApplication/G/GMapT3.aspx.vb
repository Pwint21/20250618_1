...
Partial Class GMapT3
    ...
    Protected Overrides Sub OnInit(ByVal e As System.EventArgs)
        ...
        Catch ex As Exception
            SecurityHelper.LogError("GMapT3 OnInit error", ex, Server)
            Response.Redirect("~/Login.aspx")
        End Try
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            role = userRole
            jspage = userid
            juname = SecurityHelper.HtmlEncode(Request.Cookies("userinfo")("username").ToString().ToUpper())
        ...
        Catch ex As Exception
            SecurityHelper.LogError("GMapT3 Page_Load error", ex, Server)

<%@ Page Language="VB" AutoEventWireup="false" Inherits="YTLWebApplication.GMap" Codebehind="GMap.aspx.vb" %>
...
<head>
    ...
    <link href="GMap/default.css" rel="stylesheet" type="text/css" />
     <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3.28&client=gme-zigbeeautomation&libraries=drawing&channel=YTL"></script>     <link href="GMap/gdropdown.css" rel="stylesheet" type="text/css" />
...
<![endif]-->
    ...
    <script src="GMap/GMap.js?r=<%= Now.ToString("yyyy/MM/dd HH:mm:ss") %>" type="text/javascript"></script>
</head>
